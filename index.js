...
var pJS = function(tag_id, params) {
  ...
  pJS.fn.retinaInit = function() {
    if (pJS.retina_detect && windowGlobal.devicePixelRatio > 1) {
      pJS.canvas.pxratio = windowGlobal.devicePixelRatio;
      pJS.tmp.retina = true;
    } else {
  ...
  pJS.fn.canvasSize = function() {
    ...
    if (pJS && pJS.interactivity.events.resize) {
      windowGlobal.addEventListener("resize", function() {
  ...
  pJS.fn.vendors.createSvgImg = function(p) {
    ...
    var svg = new Blob([coloredSvgXml], {
      ...
      DOMURL = windowGlobal.URL || windowGlobal.webkitURL || window,
  ...
  pJS.fn.vendors.exportImg = function() {
    windowGlobal.open(pJS.canvas.el.toDataURL("image/png"), "_blank");
  };
...
windowGlobal.requestAnimFrame = (function() {
  return (
    windowGlobal.requestAnimationFrame ||
    windowGlobal.webkitRequestAnimationFrame ||
    windowGlobal.mozRequestAnimationFrame ||
    windowGlobal.oRequestAnimationFrame ||
    windowGlobal.msRequestAnimationFrame ||
    function(callback) {
      windowGlobal.setTimeout(callback, 1000 / 60);
    }
  );
})();

windowGlobal.cancelRequestAnimFrame = (function() {
  return (
    windowGlobal.cancelAnimationFrame ||
    windowGlobal.webkitCancelRequestAnimationFrame ||
    windowGlobal.mozCancelRequestAnimationFrame ||
    windowGlobal.oCancelRequestAnimationFrame ||
    windowGlobal.msCancelRequestAnimationFrame ||
    clearTimeout
  );
})();
...
windowGlobal.particlesJS = function(tag_id, params) {
  //console.log(params);
